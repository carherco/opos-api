...
class ImportTestService {
  ...
  public function txt2csv($plain_text) {
    ...
    $patrones = [
      ...
      '/\b(\R\d+\.\s)/', // Signos . olvidados (seguidos de número de pregunta o seguidos de a), b) o c)
      '/\b(\R[a-dA-D]\)\s)/', // Signos . olvidados (seguidos de número de pregunta o seguidos de a), b) o c)
    ...
    $plain_text_cleaned = preg_replace($patrones, $sustituciones, $plain_text);
